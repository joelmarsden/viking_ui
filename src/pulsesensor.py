...
class Pulsesensor:
    ...
    def getBPMLoop(self):
        ...
        P = 16000               # used to find peak in pulse wave, seeded
        T = 16000               # used to find trough in pulse wave, seeded
        thresh = 16000          # used to find instant moment of heart beat, seeded
        ...
        while not self.thread.stopped:
            Signal = self.adc.read_adc(self.channel, gain=self.gain, data_rate=self.data_rate)
            #print(Signal)
            ...
            if N > 2500:                                # if 2.5 seconds go by without a beat
                thresh = 16000                            # set thresh default
                P = 16000                                 # set P default
                T = 16000                                 # set T default
